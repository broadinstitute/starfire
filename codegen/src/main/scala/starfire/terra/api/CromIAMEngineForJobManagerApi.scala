...
import starfire.terra.model.StatusResponse
import starfire.terra.model.VersionResponse
...
class CromIAMEngineForJobManagerApi(
  ...
  val helper = new CromIAMEngineForJobManagerApiAsyncHelper(client, config)
...
class CromIAMEngineForJobManagerApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def engineVersionStatusGet(version: String)(implicit reader: ClientResponseReader[StatusResponse]): Future[StatusResponse] = {
    ...
    if (version == null) throw new Exception("Missing required parameter 'version' when calling CromIAMEngineForJobManagerApi->engineVersionStatusGet")
  ...
  def engineVersionVersionGet(version: String)(implicit reader: ClientResponseReader[VersionResponse]): Future[VersionResponse] = {
    ...
    if (version == null) throw new Exception("Missing required parameter 'version' when calling CromIAMEngineForJobManagerApi->engineVersionVersionGet")
